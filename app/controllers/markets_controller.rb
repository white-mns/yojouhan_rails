class MarketsController < ApplicationController
  ...
  def param_set
    ...
    reference_text_assign(params, "unit_type_name_name", "unit_type_form")
    reference_text_assign(params, "unit_orig_name_name", "orig_name_form")
    ...
    reference_text_assign(params, "add_effect_name", "tokushu_form")
    reference_text_assign(params, "fuka1_name_name", "fuka1_form")
    reference_text_assign(params, "fuka2_name_name", "fuka2_form")
